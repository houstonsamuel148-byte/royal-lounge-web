...
import photo3 from "@/assets/trendy-royal-3.png.asset.json";
import photo4 from "@/assets/trendy-royal-4.png.asset.json";
import photo5 from "@/assets/trendy-royal-5.png.asset.json";
      ...
      <div className="relative mx-auto max-w-7xl px-5 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div id="book" className="relative">
          ...
          <div className="relative mt-4 h-32 rounded-2xl overflow-hidden border border-border">
            <img src={photo1.url} alt="Trendy Royal Hotel & Lounge" className="size-full object-cover" width={1600} height={1024} />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="why" className="py-24">
      <div className="mx-auto max-w-7xl px-5 grid lg:grid-cols-2 gap-12 items-center">
        <div className="relative">
          ...
          <img src={photo5.url} alt="Premium lounge" loading="lazy" width={1024} height={1024} className="relative rounded-3xl object-cover w-full aspect-square shadow-royal" />
        </div>
        <div>
...
const galleryItems = [
  { src: photo1.url, alt: "Trendy Royal Hotel & Lounge", cls: "md:col-span-2 md:row-span-2 aspect-square md:aspect-auto" },
  { src: photo2.url, alt: "Trendy Royal room", cls: "aspect-square" },
  { src: photo3.url, alt: "Trendy Royal interior", cls: "aspect-square" },
  { src: photo4.url, alt: "Trendy Royal hospitality", cls: "aspect-square" },
  { src: photo5.url, alt: "Trendy Royal lounge", cls: "aspect-square" },
  ...
  return (
    <section className="py-24 px-5">
      <div className="relative mx-auto max-w-6xl rounded-[2rem] overflow-hidden">
        <img src={photo8.url} alt="" aria-hidden className="absolute inset-0 size-full object-cover" />
